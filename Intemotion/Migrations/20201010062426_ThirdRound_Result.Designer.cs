...
namespace Intemotion.Migrations
{
    ...
    [Migration("20201010062426_ThirdRound_Result")]
    partial class ThirdRound_Result
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intemotion.Entities.ChronologyAnswer", b =>
                {
                    ...
                    b.Property<int>("ChronologyItemId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Intemotion.Entities.ChronologyAnswer", b =>
                {
                    b.HasOne("Intemotion.Entities.Rounds.ThirdRound.ChronologyItem", "ChronologyItem")
                        .WithMany()
                        .HasForeignKey("ChronologyItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
